...
// import { Inter, JetBrains_Mono } from "next/font/google"; // or whatever fonts you use
import "./globals.css";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2 pr-8">
            <Link 
              ...
              // ✅ FIX 1: Explicit label for screen readers
              aria-label="JSON-Kit Home" 
            >
              <div className="text-2xl md:text-4xl font-black tracking-tighter text-[#1a1a1a]">
                THE{" "}
                <span className="text-blue-600 relative inline-block">
                  JSON
                  {/* ✅ FIX 2: Hide decorative SVG from screen readers */}
                  <svg
                    className="absolute w-full h-3 -bottom-1 left-0 text-blue-200 -z-10"
                    viewBox="0 0 100 10"
                    preserveAspectRatio="none"
            ...
            <p className="text-sm text-gray-600 leading-relaxed font-medium max-w-md mt-4">
