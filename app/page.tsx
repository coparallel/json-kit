...
const tools = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "JSON to SQL", url: "#", icon: Database, desc: "Generate CREATE TABLE queries.", status: "Coming Soon" },
      { name: "CSV to JSON", url: "#", icon: FileSpreadsheet, desc: "Parse Excel data back into JSON.", status: "Coming Soon" },
  ...
  },
  {
    category: "Generators",
    items: [
      { name: "Text to Schema", url: "#", icon: Sparkles, desc: "AI-powered JSON Schema generation.", status: "Coming Soon" },
      { name: "JSON to Types", url: "#", icon: Code2, desc: "TypeScript, Go, and Python interfaces.", status: "Coming Soon" }
    ]
  }
];
          ...
          <div key={category.category} className="bg-white/50 p-6 rounded-xl border border-black/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {category.items.map((tool) => {
                // 🛠️ THE FIX: Determine if we need a Link or a plain Div
                ...
                return isComingSoon ? (
                  <div
                    ...
                    className={`
                      ...
                      opacity-70 cursor-not-allowed border-dashed select-none
                    `}
                    aria-disabled={true}
                  >
                    <div>
                      <div className="flex justify-between items-start mb-4">
                        <div className={`p-2 rounded border border-black ${isComingSoon ? "bg-gray-100" : "bg-blue-50 group-hover:bg-blue-100"}`}>
                      ...
                      <h3 className={`text-lg font-bold mb-2 font-mono ${!isComingSoon && "group-hover:text-blue-700"}`}>
                        {tool.name}
                      </h3>
                  ...
                  <Link
                    ...
                    className={`
                      group relative flex flex-col justify-between
                      bg-white border-2 border-black p-5 rounded-lg
                      shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer
                    `}
                  >
                    <div>
                      <div className="flex justify-between items-start mb-4">
                        <div className={`p-2 rounded border border-black bg-blue-50 group-hover:bg-blue-100`}>
                          <tool.icon size={22} strokeWidth={2} />
                        </div>
                      </div>
